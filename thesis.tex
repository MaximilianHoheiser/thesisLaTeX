...
\setuniversity{University Name}{Universitaets Name} %if both englisch and german titlepages are used, both must be supplyed
\setfaculty{Faculty}{Fakultaet} 
...
%if you like to write a chapter in the main file
...
\bibliography{./example/example} %implements a bibliography for a chapter, where the bib file is stored in a sepperat chapter folder
